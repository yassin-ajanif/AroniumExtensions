...
Gmail: energietechsolution@gmail.com";
    ...
    public RelayCommand PrintFactureCommand { get; }

    public FactureViewModel(MainWindowViewModel? mainViewModel = null)
    {
        ...
        PrintFactureCommand = new RelayCommand(async () => await PrintFactureAsync(), () => !IsPrinting);
    ...
    public bool IsPrinting
    {
        ...
        set
        {
            if (_isPrinting != value)
            {
                _isPrinting = value;
                RaisePropertyChanged();
                PrintFactureCommand?.RaiseCanExecuteChanged();
            }
        }
    }
    ...
    private async Task LoadDocumentFromDatabaseAsync()
    {
        try
        {
            ...
            OrderDate = documentData.Date; // You might want to get this from documentData if available
    ...
    // Print Facture Method
    private async Task PrintFactureAsync()
    {
        ...
        try
        {
            ...
            await ServiceProvider.FacturePdfService.ShowFacturePreviewAsync(this, _mainViewModel);
